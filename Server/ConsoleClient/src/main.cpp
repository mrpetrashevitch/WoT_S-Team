#include "../../WGclient/src/include.h"
#include <iostream>
#include <string>
#include <mutex>
...
void thre(web::io_client::i_client* cl, web::packet::packet_string* p)
{
...
int main()
{
	...
	if (str.size() > 0)
	{
		web::packet::packet_string p(str.c_str());

		/*auto client = ld.create_fn(192, 168, 100, 16, 5001);
